...
from app.agents.prompts import MODEL_SYSTEM_PROMPT
from app.agents.provider import openrouter_provider
from app.chat.models import (
    ChatAgentResult,
    ChatMessage,
    ChatSource,
)
from app.domain import AnalysisResponse, CounterpartyCard
...
class ChatModelOutput(BaseModel):
    ...
    citations: list[ChatModelCitation] = Field(
        ...
        description=(
            "Пары inn/field для машинной проверки фактов; не дублировать их в answer"
        ),
    )
