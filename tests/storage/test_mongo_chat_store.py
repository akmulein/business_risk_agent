...
from counterparty_verification.chat.models import ChatMessage, ChatRole
from counterparty_verification.domain import AnalysisResponse, RiskLevel
from counterparty_verification.storage.sessions import MongoChatSessionStore
...
class FakeCollection:
    ...
    async def update_one(self, query, update):
        ...
        self.document["messages"].extend(deepcopy(update["$push"]["messages"]["$each"]))
